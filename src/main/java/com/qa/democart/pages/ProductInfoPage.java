...
public class ProductInfoPage {
	...
	private By productsImages = By.cssSelector("ul.thumbnails img");
	...
	public ProductInfoPage(WebDriver driver) { // constructor of this class
		this.driver = driver;
	...
	public int getProductImagesCount() {
		return elementUtil.getElements(productsImages).size();
	}
	...
	public Map<String, String> getProductInfo() {
		...
		for (WebElement e : metaDataList) {
			String meta[] = e.getText().split(":"); // split bases on colum :
		...
		System.out.println("total product list: " + priceList.size());
